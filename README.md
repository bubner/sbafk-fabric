# sbafk-fabric
### Continued port of [sbafk](https://github.com/bubner/sbafk) for Fabric 1.21.10
...
Offers an invasive or non-invasive mode, whether to try and take action or to simply alert the Discord webhook.
<br><br>
Command: `/sbafk`
